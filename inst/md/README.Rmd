...
The benchmark data set generation can be initiated in the panel 'Generate Benchmark'. In the following the setup of necessary csv and mzML files is explained. 
