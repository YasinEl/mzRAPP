...
<br>
<b>Interpretation:</b><br>
High number of alignment errors can be partly due to a high number of split peaks (discussed above) or too wide/narrow search width in mz or RT dimension by the non-targeted algorithm. Lost peaks can often be attributed to NPP alignment settings which delete features if they are not populated by enough peaks or when peak areas are adapted in the feature processing step. <br>
<br>
<b>Displayed in results as:</b><br>
