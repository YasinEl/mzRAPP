...
```{r figure1, fig.height=1, fig.width=1, echo=FALSE,fig.cap="\\label{fig:figure1}<b>Figure 1 | </b> Matching rules of BP with NP"}
...
```{r figure2, out.width="100%", out.height="50%", echo=FALSE,fig.cap="\\label{fig:figure2}<b>Figure 2 | </b> Counting alignment errors"}
