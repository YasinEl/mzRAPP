...
Isotopologue areas are predicted from the most abundant isotopologue of all compounds. If the relative error of this prediction is more than 20 %p higher for NT-peak areas (compared to benchmark-areas) it is refelcted in this variable. Here only peak areas after the alignment step are considered. <br>
<br>
...
```{r figure1, fig.width=5, echo=FALSE,fig.cap="\\label{fig:figure1}<b>Figure 1 | </b> Matching rules of BP with NP"}
