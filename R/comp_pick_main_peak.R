...
pick_main_peak <- function(dt){
  ...
  main_peak_dt <- dt[, pick_main_peak_sd(.SD), by=c('molecule_b', 'adduct_b', 'sample_id_b'), .SDcols=c('molecule_b', 'adduct_b', 'sample_id_b', 'comp_id_b', 'comp_id_ug', 'isoabb_b', 'rt_start_ug', 'rt_end_ug', 'peak_area_ug')]
